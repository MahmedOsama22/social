package com.social18.activities;
...
import com.social18.model.User;
...
import static com.social18.help.Helper.COLLECTION_USERS;
import static com.social18.help.Helper.USER_PROFILE_PICTURE;
                ...
                if (task.isSuccessful()){
                    ...
                    currentUser.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            User user = new User(password, day, month, year, finalGender);
                                    ...
                                    if (profilePicUri != null) {
                                        try {
                                            ...
                                            FirebaseStorage.getInstance().getReference().child(COLLECTION_USERS)
                                                    ...
                                                    .child("profile_picture").putBytes(bytes);
